...
# 构建优化后的RNN模型
model = Sequential()
model.add(LSTM(50, activation='tanh', input_shape=(1, n_features), return_sequences=True))
model.add(Dropout(0.3))  # 添加Dropout层，丢弃30%的神经元
model.add(LSTM(30, activation='tanh'))  # 增加第二层LSTM
